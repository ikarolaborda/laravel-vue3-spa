<template>
    <form @submit.prevent="storePost(post)">
        ...
        <!-- Buttons -->
        <div class="mt-5 mx-auto text-right">
            <button :disabled="isLoading" class="inline-flex items-center px-8 py-2 bg-blue-600 text-white rounded disabled:opacity-75 disabled:cursor-not-allowed">
